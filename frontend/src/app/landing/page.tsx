...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#050505] text-white" style={{ fontFamily: "Outfit, sans-serif" }}>
      ...
      {/* Nav */}
      <nav className="flex items-center justify-between px-4 sm:px-8 py-1 max-w-7xl mx-auto relative z-20 border-b border-[#1a1a1a]">
        <img src="/logo.png" alt="Bahamut.AI" className="h-12 sm:h-14" />

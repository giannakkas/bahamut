...
# get_all_strategy_trusts() and get_all_pattern_trusts() DELETED.
# They queried non-existent DB tables (trust_state, trust_patterns).
# Trust dashboard now uses get_trust_overview() + get_pattern_trust() — proven Redis path.

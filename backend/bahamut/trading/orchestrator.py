            ...
            if "v5" in strat_name:
                ...
                if not _v5_enabled:
                    logger.debug("v5_production_gate_blocked",
                                 ...
                                 reason="V5_PRODUCTION_ENABLED=0 — signal routed to debug only")
                    continue  # Don't increment strategy_signals_found → debug_exploration will run
